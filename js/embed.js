...
function sskadmin(e) {
    ...
    if (e.user_id == 6362267528038712065) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">不二博主</span></span><div style="position:absolute;margin-left:300px;width:300px;height:100px;"><img src="../img/zhanzhang.png"></div>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin"><p><font size="4" face="verdana" color="#2F0000">不二博主</font></p></span></span><div style="position:absolute;margin-left:300px;width:300px;height:100px;"><img src="../img/zhanzhang.png"></div>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
